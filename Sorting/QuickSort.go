...
func QuickSort(arr []int, low, high int) {
	if low < high {
		...
		// Unlike mergesort, the actual array isn't being divided and then merged together into a new array. This is just getting the source array and the indexs will be altering or "dividing" until we reach elements that are the size of one. Once they are that size, they are technically completed
